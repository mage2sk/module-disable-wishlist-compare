<?php
/**
 * Standalone install + heartbeat reporter for Panth_DisableWishlistCompare.
 *
...
namespace Panth\DisableWishlistCompare\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_DisableWishlistCompare';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-disable-wishlist-compare';
